...
class Converter:
    def __init__(self, parent):
        ...
        self.converter_frame = Frame(width=640, height=480, bg=background_color,
                                     pady=10)
        ...
        self.help_button = Button(self.converter_frame, text="Help",
                                  font="ubuntu 14",padx=10, pady=10, command=self.help)
...
class Help:
    def __init__(self, partner):
        ...
        self.dismiss_btn = Button(self.help_frame, text="Dismiss", width=10, bg="orange",
                                  font="ubuntu 10 bold", command=partial(self.close_help, partner))
